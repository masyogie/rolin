...
// configurations
$server = 'http://rolin.loenpia.net:8000'; //url to your icecast server, with "http://", without the ending "/"
//$server = 'http://202.52.146.52:8000';
$mount = '/stream'; //your radio's mount point, with the leading "/"
//$mount = '/konser';
$lastfm_api = 'de96e2ccbfe2fc85da1ad815333b9cba'; //your last.fm API key, get from http://www.last.fm/api/account
$default_album_art = 'cache/default.jpg';//the default album art image, will be used if failed to get from last.fm's API
$get_track_info = 'false'; //get information of the current song from last.fm
$get_album_info = 'false'; //get extra information of the album from last.fm, if enabled, may increase script execute time
$get_artist_info = 'false'; //get extra information of the artist from last.fm, if enabled, may increase script execute time
$get_lyrics = 'false'; //get lyrics of the current song using chartlyrics.com's API
$cache_album_art = 'false';//cache album art images to local server
...
function getStreamStatus($server, $mount){
        ...
        if($header[0] == 'HTTP/1.0 200 OK'){
                ...
                return  'Maaf, Kami Sedang Off Air';
        }
}
